...
/** Price for display, honouring `fromPrice`. Hair, hair-treatment, and bridal
 *  services depend on length and density, so their printed rate is a floor.
 *  Everywhere a price is shown uses this rather than formatPrice directly, so
 *  the qualifier cannot appear on the menu but go missing in the booking flow. */
