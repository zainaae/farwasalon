...
See **Last verified** at the end of this doc for the current nslookup snapshot. Recommended Namecheap targets remain `@` → `216.198.79.1` and `www` → `25cff91a97a4946f.vercel-dns-017.com`.
