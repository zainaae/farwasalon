  ...
  return (
    ...
    >
      <div className="section-shell py-2.5 md:py-3 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-center">
        <p className="text-[11px] md:text-xs font-[family-name:var(--font-inter)] tracking-wide leading-snug">
        ...
        <Link
          ...
          className="tap-safe inline-flex items-center gap-1 text-[11px] md:text-xs tracking-[0.14em] uppercase font-semibold font-[family-name:var(--font-inter)] text-white underline underline-offset-4 decoration-accent-gold hover:decoration-white transition-colors"
        >
