...
export const metadata = {
  ...
  description: `From a single chair in 2008 to a full-service studio — meet Rubina and the team behind ${YEARS_ACTIVE}+ years at Farwa Beauty Salon, PECHS Block 3, Karachi.`,
