...
export function getStaticSitemapEntries() {
  ...
  return [
    ...
    { url: `${SITEMAP_BASE}/deals`, lastModified: fresh, changeFrequency: 'weekly', priority: 0.8 },
    { url: `${SITEMAP_BASE}/freedom-deal`, lastModified: fresh, changeFrequency: 'daily', priority: 0.9 },
