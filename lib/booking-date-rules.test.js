...
describe('validateBookingDate — format', () => {
  ...
  it('handles impossible dates by JS rollover (Feb 30 → Mar 2, which is in past → rejected)', () => {
    // JS coerces 2026-02-30 to 2026-03-02; relative to TODAY=2026-05-19 that's "past".
